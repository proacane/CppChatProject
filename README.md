...
基于 C++ / Boost.Asio / gRPC 的多人全栈聊天项目。本项目是参照 B 站 **恋恋风尘Zack** 的全栈聊天项目教程实现的学习产物，按其分层思路将服务端拆分为多个独立微服务，并配合一个 Qt 桌面客户端完成端到端联调。

> 说明：本仓库为学习用途的实现，并非生产级产品。仓库中的代码、配置和文档主要用于梳理和复习教程中讲解的核心逻辑。
...
本项目实现思路与课程主线来自 B 站 UP 主 **恋恋风尘Zack** 的全栈聊天项目教程，本仓库代码为按其教学过程逐步实现并整理的版本，向原作者致谢。

如需了解课程原始讲解与设计动机，请参考作者本人的视频与配套文档。
